                ...
                <table role="presentation"
                    ...
                    <tr style="border-collapse:collapse;border:1px solid #cccccc;border-spacing:0;">
                        <td align="left" style="padding:10px 25px;background:#fff; display: flex; align-items: center;">
                             <span style="font-weight: bold; padding-top: 10px;"> Symox Admin </span>
                        </td>
                    </tr>
                    <tr>
                                ...
                                <tr>
                                    <td style="padding:0 0 36px 0;color:#153643;">
                                        ...
                                        <p style="text-align: center;">
                                            <a href="<?= base_url('reset-password/'.$token) ?>" class="btn">Reset Your Password</a>
                                        </p>
                                        <p style="margin:100px 0 12px 0;font-size:14px;font-family:Arial,sans-serif;">Thankyou. </p>
                                    </td>
                                </tr>
                            </table>
                        </td>
