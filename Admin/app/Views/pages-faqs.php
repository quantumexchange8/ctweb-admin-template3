                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div>
                                                                            <div class="d-flex align-items-start mt-4">
                                                                                <div class="flex-shrink-0 me-3">
                                                                                    <h5 class="text-primary font-size-16">01.</h5>
                                                                                </div>
            
                                                                                <div class="flex-grow-1">
                                                                                    <h5 class="font-size-16">What is Lorem Ipsum ?</h5>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div>
                                                                            <div class="d-flex align-items-start mt-4">
                                                                                <div class="flex-shrink-0 me-3">
                                                                                    <h5 class="text-primary font-size-16">02.</h5>
                                                                                </div>
            
                                                                                <div class="flex-grow-1">
                                                                                    <h5 class="font-size-16">Where does it come from ?</h5>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div>
                                                                            <div class="d-flex align-items-start mt-4">
                                                                                <div class="flex-shrink-0 me-3">
                                                                                    <h5 class="text-primary font-size-16">03.</h5>
                                                                                </div>
            
                                                                                <div class="flex-grow-1">
                                                                                    <h5 class="font-size-16">Why do we use it ?</h5>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div>
                                                                            <div class="d-flex align-items-start mt-4">
                                                                                ...
                                                                                <div class="flex-grow-1">
                                                                                    <h5 class="font-size-16">Where can I get some ?</h5>
                                                                                    <p class="text-muted">If several languages coalesce, the grammar of the resulting language is more simple</p>
                                                                                </div>
                                                                            </div>
                                                                        </div>
