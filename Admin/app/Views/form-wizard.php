                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="mb-3">
                                                                <label for="basicpill-firstname-input" class="form-label">First
                                                                    Name</label>
                                                                <input type="text" class="form-control" placeholder="Enter First Name" id="basicpill-firstname-input">
                                                            </div>
                                                        </div><!-- end col -->
                                                        <div class="col-lg-6">
                                                            <div class="mb-3">
                                                                <label for="basicpill-lastname-input" class="form-label">Last
                                                                    Name</label>
                                                                <input type="text" class="form-control" placeholder="Enter Last Name" id="basicpill-lastname-input">
                                                            </div>
                                                        </div><!-- end col -->
                                                    </div><!-- end row -->
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" class="form-control" placeholder="Enter Phone" id="basicpill-phoneno-input">
                                                            </div>
                                                        </div><!-- end col -->
                                                        <div class="col-lg-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="email" class="form-control" placeholder="Enter Email" id="basicpill-email-input">
                                                            </div>
                                                        </div><!-- end col -->
                                                    </div><!-- end row -->
                                                    <div class="row">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="text" class="form-control" id="datepicker-basic" placeholder="Enter Expiration Date" >
                                                                </div>
                                                            </div>
                                                        </div><!-- end row -->
                                                    </div><!-- end form -->
