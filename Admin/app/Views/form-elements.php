                            ...
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3 row">
                                            <label for="exampleColorInput" class="col-md-2 col-form-label">Color picker</label>
                                            <div class="col-md-10">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-xl-6">
                                                <div class="mt-4 mt-xl-0">
                                                    <h5 class="font-size-14"><i class="mdi mdi-arrow-right text-primary"></i> Custom file input</h5>
                                                    <div class="mt-4">
