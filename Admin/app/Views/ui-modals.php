                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <p class="card-title-desc">Use <code>event.relatedTarget</code> and HTML <code>data-bs-*</code> attributes to vary the contents of the modal depending on which button was clicked.</p>
                                    </div><!-- end card header -->
