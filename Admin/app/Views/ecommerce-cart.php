                                ...
                                <div class="card border shadow-none">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-start border-bottom pb-3">
                                            ...
                                            <div class="flex-grow-1 align-self-center overflow-hidden">
                                                <div>
                                                    <h5 class="text-truncate font-size-16"><a href="ecommerce-product-detail" class="text-dark">Sport Running Shoes</a></h5>
                                                    <p class="mb-1">Color : <span class="fw-medium">Gray And Red</span></p>
                                                    <p>Size : <span class="fw-medium">08</span></p>
                                                </div>
                                            </div>
                                            <div class="flex-shrink-0 ms-2">
                                        ...
                                        <div class="d-flex align-items-start border-bottom pb-3">
                                            ...
                                            <div class="flex-grow-1 align-self-center overflow-hidden">
                                                <div>
                                                    ...
                                                    <p class="mb-1">Color : <span class="fw-medium">Purple</span></p>
